  ...
  <div class="page-container">
    ...
    <div class="card border-purple shadow-lg">
      <div class="card-body bg-light-purple">
        ...
        <NuxtLink class="btn btn-purple btn-hover mt-auto text-white text-decoration-none" to="lessons/connection_BDD">
          Accès à la leçon
        </NuxtLink>
      </div>
    </div>
    ...
    <div class="card border-purple shadow-lg">
      <div class="card-body bg-light-purple">
        ...
        <p class="card-text">Les variables en PHP</p>
        <NuxtLink class="btn btn-purple btn-hover mt-auto text-white text-decoration-none" to="lessons/variable_php">
          Accès à la leçon
        </NuxtLink>
      </div>
    </div>
