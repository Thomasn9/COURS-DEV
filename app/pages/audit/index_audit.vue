<template>
    <div class="page-container">
        ...
        <div class="card border-purple shadow-lg">
            <div class="card-body bg-light-purple">
                <h5 class="card-title text-purple">Audit Performance</h5>
                <p class="card-text">Le role et l'utilité de l'audit performance dans la gestion d'un projet</p>
                <NuxtLink class="btn btn-purple btn-hover mt-auto text-white text-decoration-none"
                    to="lessons/audit_performance">
                    Accès à la leçon
                </NuxtLink>
            </div>
        </div>
        ...
        <div class="card border-purple shadow-lg">
            <div class="card-body bg-light-purple">
                <h5 class="card-title text-purple">Audit Sécurité</h5>
                <p class="card-text">Le role et l'utilité de l'audit de sécuriter dans la gestion d'un projet</p>
                <NuxtLink class="btn btn-purple btn-hover mt-auto text-white text-decoration-none"
                    to="lessons/audit_securiter">
                    Accès à la leçon
                </NuxtLink>
            </div>
        </div>
        ...
        <div class="card border-purple shadow-lg">
            <div class="card-body bg-light-purple">
                <h5 class="card-title text-purple">Mock</h5>
                <p class="card-text">Qu'elle est l'utilité des mocks dans le testing</p>
                <NuxtLink class="btn btn-purple btn-hover mt-auto text-white text-decoration-none"
                    to="lessons/mock">
                    Accès à la leçon
                </NuxtLink>
