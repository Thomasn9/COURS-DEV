<template>
    <div class="page-container">
        <div class="section-header">
            <h3 class="lettreSommaire">Introduction a JAVA</h3>
        </div>
        ...
        <div class="card border-purple shadow-lg">
            <div class="card-body bg-light-purple">
                <h5 class="card-title text-purple">Fonction</h5>
                <p class="card-text">Les fonction en JAVA et leur syntaxe</p>
                <NuxtLink class="btn btn-purple btn-hover mt-auto text-white text-decoration-none"
                    to="lessons/fonction">
                    Accès à la leçon
                </NuxtLink>
        ...
        <div class="card border-purple shadow-lg">
            <div class="card-body bg-light-purple">
                <h5 class="card-title text-purple">Méthode main</h5>
                <p class="card-text">La methode main en java</p>
                <NuxtLink class="btn btn-purple btn-hover mt-auto text-white text-decoration-none"
                    to="lessons/main">
                    Accès à la leçon
                </NuxtLink>
        ...
        <div class="card border-purple shadow-lg">
            <div class="card-body bg-light-purple">
                ...
                <p class="card-text">Le map en java</p>
                <NuxtLink class="btn btn-purple btn-hover mt-auto text-white text-decoration-none"
                    to="lessons/map">
                    Accès à la leçon
                </NuxtLink>
