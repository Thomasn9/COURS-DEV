<template>
    <div class="page-container">
            ...
            <h3 class="lettreSommaire">Framework Symfony</h3>
        </div>
        ...
        <div class="card border-purple shadow-lg">
            <div class="card-body bg-light-purple">
                <h5 class="card-title text-purple">Architecture exagonale</h5>
                <p class="card-text">Quest ce que l'architecture exagonale ?</p>
                <NuxtLink class="btn btn-purple btn-hover mt-auto text-white text-decoration-none"
                    to="lessons/architecture_exa">
                    Accès à la leçon
                </NuxtLink>
            </div>
        </div>
        ...
        <div class="card border-purple shadow-lg">
            <div class="card-body bg-light-purple">
                <h5 class="card-title text-purple">Boostrap</h5>
                <p class="card-text">Intégration de boostrap dans symfony</p>
                <NuxtLink class="btn btn-purple btn-hover mt-auto text-white text-decoration-none"
                    to="lessons/boostrap">
                    Accès à la leçon
                </NuxtLink>
        ...
        <div class="card border-purple shadow-lg">
            <div class="card-body bg-light-purple">
                <h5 class="card-title text-purple">Génération d'un controller</h5>
                <p class="card-text">Comment générer un controller via des commande symfony</p>
                <NuxtLink class="btn btn-purple btn-hover mt-auto text-white text-decoration-none"
                    to="lessons/generer_controller">
                    Accès à la leçon
                </NuxtLink>
            </div>
        </div>
        ...
        <div class="card border-purple shadow-lg">
            <div class="card-body bg-light-purple">
                ...
                <p class="card-text">Le controlle d'acces grace a isGranted</p>
                <NuxtLink class="btn btn-purple btn-hover mt-auto text-white text-decoration-none"
        ...
        <div class="card border-purple shadow-lg">
            <div class="card-body bg-light-purple">
                <h5 class="card-title text-purple">Live component</h5>
                <p class="card-text">Symfony UX & Live Component : Le dynamisme sans JavaScript</p>
                <NuxtLink class="btn btn-purple btn-hover mt-auto text-white text-decoration-none"
                    to="lessons/liveComponent">
                    Accès à la leçon
                </NuxtLink>
            </div>
        </div>
        ...
        <div class="card border-purple shadow-lg">
            <div class="card-body bg-light-purple">
                <h5 class="card-title text-purple">Migration</h5>
                <p class="card-text">A quoi sert un fichier migration dans symfony</p>
                <NuxtLink class="btn btn-purple btn-hover mt-auto text-white text-decoration-none"
                    to="lessons/migration">
                    Accès à la leçon
                </NuxtLink>
            </div>
        </div>
        ...
        <div class="card border-purple shadow-lg">
            <div class="card-body bg-light-purple">
                <h5 class="card-title text-purple">Sécurité formulaire</h5>
                <p class="card-text">La sécuriter dans un formulaire symfony grace a twig et doctrine</p>
                <NuxtLink class="btn btn-purple btn-hover mt-auto text-white text-decoration-none"
                    to="lessons/securiter_form">
                    Accès à la leçon
                </NuxtLink>
            </div>
        </div>
        ...
        <div class="card border-purple shadow-lg">
            <div class="card-body bg-light-purple">
                <h5 class="card-title text-purple">security.yaml</h5>
                <p class="card-text">Le fichier security.ymal et son utiliter dans symfony</p>
                <NuxtLink class="btn btn-purple btn-hover mt-auto text-white text-decoration-none"
                    to="lessons/security_yaml">
                    Accès à la leçon
                </NuxtLink>
            </div>
        </div>
        ...
        <div class="card border-purple shadow-lg">
            <div class="card-body bg-light-purple">
                <h5 class="card-title text-purple">Stimulus</h5>
        ...
        <div class="card border-purple shadow-lg">
            <div class="card-body bg-light-purple">
                <h5 class="card-title text-purple">Twig</h5>
...
/* Classes CSS de l'autre page appliquées */
.bg-gradient-primary {
...
.shadow-lg {
    box-shadow: 0 4px 25px rgba(106, 48, 147, 0.1) !important;
}
...
/* Styles pour les liens NuxtLink */
.text-white {
