    ...
    <div class="lesson-container">
        <div class="lesson-content">
            ...
            <div class="lesson-header">
                ...
                <p class="lesson-meta text-white" v-pre>Découvrez le framework PHP qui révolutionne le développement web
                </p>
            </div>
            ...
            <div class="lesson-section bg-light-purple border-purple">
                ...
                <div class="textExemple" v-pre>
                    <strong>Symfony en chiffres :</strong> Plus de 600 000 développeurs, utilisé par 75% des sites PHP
                    français,
                    plus de 3 000 contributeurs, une communauté mondiale active et des mises à jour régulières avec du
                    support long terme.
                </div>
            </div>
            ...
            <div class="lesson-section bg-light-purple border-purple">
                ...
                <div class="code-comparison">
                    <div class="textExemple">
                        ...
                        <p v-pre>Composants réutilisables, chaque fonctionnalité est indépendante, vous utilisez
                            seulement ce dont vous avez besoin.</p>
                    </div>

                    <div class="textExemple">
                        <h4 class="text-purple" v-pre>Configuration sobre</h4>
                        <p v-pre>Convention over Configuration, moins de configuration, plus de codage, paramètres par
                            défaut intelligents.</p>
                    </div>
                </div>
                ...
                <div class="code-comparison">
                    <div class="textExemple">
                        ...
                        <p v-pre>Architecture flexible, personnalisation avancée, Bundle system pour étendre les
                            fonctionnalités.</p>
                    </div>

                    <div class="textExemple">
                        <h4 class="text-purple" v-pre>Standards ouverts</h4>
                        <p v-pre>Respect des standards PHP, PSR (PHP Standards Recommendations), interopérabilité avec
                            d'autres librairies.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="lesson-section bg-light-purple border-purple">
                ...
                <div class="textExemple" v-pre>
                    <strong>Structure MVC de Symfony :</strong> Le dossier src contient les contrôleurs, le dossier
                    Entity contient les modèles (entités),
                ...
                <div class="code-comparison">
                    <div class="textExemple">
                        ...
                        <p v-pre>Les contrôleurs gèrent les requêtes HTTP et retournent des réponses. Ils contiennent la
                            logique métier de l'application.</p>
                    </div>

                    <div class="textExemple">
                        <h4 class="text-purple" v-pre>Vue (Twig)</h4>
                        <p v-pre>Les vues utilisent le moteur de template Twig pour afficher l'interface utilisateur de
                            manière séparée de la logique.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="lesson-section bg-light-purple border-purple">
                ...
                <div class="code-comparison">
                    ...
                    <div class="textExemple">
                        ...
                        <p v-pre>Chaque composant peut être utilisé indépendamment via Composer. Par exemple, le
                            composant Validator peut être utilisé seul pour valider des données dans n'importe quel
                            projet PHP.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="lesson-section bg-light-purple border-purple">
                ...
                <div class="textExemple" v-pre>
                    <strong>Entreprises qui utilisent Symfony :</strong> BlaBlaCar, Spotify, Dailymotion,
                    OpenClassrooms, et des milliers d'autres entreprises à travers le monde.
                </div>
            </div>
            ...
            <div class="lesson-section bg-light-purple border-purple">
                ...
                <div class="code-comparison">
                    <div class="textExemple">
                        ...
                        <p v-pre>Symfony offre plus de flexibilité et une architecture modulaire, idéal pour les projets
                            complexes. Laravel est plus simple à débuter avec un écosystème intégré, idéal pour les MVP
                            rapides.</p>
                    </div>

                    <div class="textExemple">
                        <h4 class="text-purple" v-pre>Comparaison avec un framework maison</h4>
                        <p v-pre>Symfony apporte une sécurité éprouvée, une maintenance garantie et une communauté
                            active. Un framework maison peut être sur-mesure mais présente des risques de sécurité et
                            une maintenance coûteuse.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="lesson-section bg-light-purple border-purple">
                ...
                <div class="exercise">
                    <p class="textExemple" v-pre>
                        <strong>Objectif :</strong> Identifier les avantages de Symfony pour différents scénarios de
                        projet.
                    </p>
                ...
                <details class="solution">
                    ...
                    <div class="solution-content">
                        ...
                        <div class="textExemple">
                            ...
                            <p v-pre>Symfony avec MakerBundle pour prototypage rapide, composants Form et Validator pour
                                les données, Security pour l'authentification. Avantage : Évolutivité quand le projet
                                grandit.</p>
                        </div>

                        <div class="textExemple">
                            <h5 v-pre>Migration Legacy</h5>
                            <p v-pre>Utilisation progressive des composants Symfony, Doctrine pour l'abstraction base de
                                données, Console pour les scripts de migration. Avantage : Stabilité et maintenabilité.
                            </p>
                        </div>

                        <div class="textExemple">
                            <h5 v-pre>Site Vitrine</h5>
                            <p v-pre>Symfony avec Twig pour les templates, Routing pour le SEO, Cache pour les
                                performances. Avantage : Facilité de maintenance future.</p>
                        </div>

                        <div class="textExemple">
                            <h5 v-pre>API Mobile</h5>
                            <p v-pre>API Platform ou composant Serializer, Security JWT pour l'authentification,
                                Validator pour la data validation. Avantage : Standards REST, documentation auto.</p>
                        </div>
                    </div>
                </details>
            </div>
