        ...
        <div class="lesson-content">
            ...
            <section class="lesson-section bg-light-purple border-purple">
                ...
                <p class="textExemple" v-pre>
                    Dans cette leçon, nous allons apprendre comment récupérer des données depuis une API Symfony dans
                    une application Nuxt.
                    Cette compétence est essentielle pour créer des applications modernes où le frontend (Nuxt) et le
                    backend (Symfony) sont découplés.
                </p>
                <p class="textExemple" v-pre>
                    Nous aborderons plusieurs méthodes de fetch : <code>$fetch</code>, <code>useFetch</code> et
            ...
            <section class="lesson-section bg-light-purple border-purple">
                ...
                <p class="textExemple" v-pre>
                    Avant de pouvoir fetch des données depuis Nuxt, assurez-vous que votre API Symfony est correctement
                    configurée pour accepter les requêtes CORS.
                </p>
    ...
    <span class="variable">paths</span>:
        <span class="string">'^/api/'</span>:
            ...
            <span class="property">max_age</span>: <span class="number">3600</span></code></pre>
                ...
                <div class="code-example">
                    <pre
                        v-pre><code class="language-bash">CORS_ALLOW_ORIGIN=^https?://(localhost|127\.0\.0\.1)(:[0-9]+)?$</code></pre>
                </div>
            </section>
        ...
        <span class="function">useToast</span>().<span class="function">error</span>(<span class="string">'Accès refusé'</span>)
            ...
            <section class="lesson-section bg-light-purple border-purple">
                ...
                <div class="exercise">
                    ...
                    <p class="textExemple" v-pre>
                        Créez une page Nuxt qui affiche une liste d'articles depuis une API Symfony. L'API Symfony
                        expose un endpoint <code>/api/articles</code> qui retourne des articles au format JSON.
                    </p>
