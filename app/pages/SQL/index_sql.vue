<template>
    <div class="page-container">
        ...
        <div class="card border-purple shadow-lg">
            <div class="card-body bg-light-purple">
                <h5 class="card-title text-purple">Création BDD</h5>
                <p class="card-text">La création de base de donnée SQL de base.</p>
                <NuxtLink class="btn btn-purple btn-hover mt-auto text-white text-decoration-none"
                    to="lessons/creation_bdd">
                    Accès à la leçon
                </NuxtLink>
            </div>
        </div>
        ...
        <div class="card border-purple shadow-lg">
            <div class="card-body bg-light-purple">
                <h5 class="card-title text-purple">Forgeign key</h5>
                <p class="card-text">Les foreign key ou clef etrangère en francais a quoi servent-elle et comment les
                    utiliser</p>
                <NuxtLink class="btn btn-purple btn-hover mt-auto text-white text-decoration-none"
                    to="lessons/foreign_key">
                    Accès à la leçon
                </NuxtLink>
            </div>
        </div>
        ...
        <div class="card border-purple shadow-lg">
            <div class="card-body bg-light-purple">
                <h5 class="card-title text-purple">Insert Into</h5>
                <p class="card-text">les insert into en SQL</p>
                <NuxtLink class="btn btn-purple btn-hover mt-auto text-white text-decoration-none"
                    to="lessons/insert_into">
                    Accès à la leçon
                </NuxtLink>
            </div>
        </div>
