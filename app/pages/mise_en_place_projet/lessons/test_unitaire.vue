  ...
  <div class="lesson-container">
    <div class="lesson-content">
      ...
      <header class="lesson-header">
        ...
        <p class="lesson-meta text-white">Apprenez à configurer et utiliser Vitest pour tester votre code JavaScript</p>
      </header>
      ...
      <section class="lesson-section bg-light-purple border-purple">
        ...
        <p class="textExemple">
          Les tests unitaires sont essentiels pour garantir la fiabilité de votre code. Ils permettent de vérifier que chaque partie de votre application fonctionne correctement, isolément. Dans cette leçon, nous allons découvrir comment configurer et utiliser Vitest, un framework de test rapide et moderne pour JavaScript.
        </p>
      </section>
  ...
  <span class="function">expect</span>(() => <span class="function">divide</span>(<span class="number">5</span>, <span class="number">0</span>)).<span class="function">toThrow</span>(<span class="string">'Division par zéro impossible'</span>);
      ...
      <section class="lesson-section bg-light-purple border-purple">
        ...
        <div class="function-explanation">
          ...
          <p class="textExemple">
            La fonction <code>test()</code> (ou son alias <code>it()</code>) est utilisée pour définir un test individuel. Elle prend deux paramètres :
          </p>
          <ul class="textExemple">
            <li><strong>Nom du test</strong> : Une chaîne de caractères descriptive qui explique ce que le test vérifie</li>
            <li><strong>Fonction de test</strong> : Une fonction qui contient la logique du test et les assertions</li>
          </ul>
...
<span class="function">test</span>(<span class="string">'description du test'</span>, () => {
  <span class="comment">// Logique du test et assertions</span>
        ...
        <div class="function-explanation">
          ...
          <p class="textExemple">
            La fonction <code>expect()</code> est utilisée pour créer une assertion. Elle prend une valeur (le résultat de votre fonction) et retourne un objet qui vous permet de vérifier cette valeur contre des conditions spécifiques.
          </p>
...
<span class="function">expect</span>(<span class="function">add</span>(<span class="number">2</span>, <span class="number">3</span>))</code></pre>
          ...
          <p class="textExemple">
            Après <code>expect()</code>, vous pouvez chaîner différents <strong>matchers</strong> pour vérifier différentes conditions.
          </p>
        </div>
        ...
        <div class="function-explanation">
          ...
          <p class="textExemple">
            <code>toBe()</code> est un <strong>matcher</strong> qui vérifie l'égalité stricte (comme <code>===</code> en JavaScript). Il est idéal pour comparer des valeurs primitives (nombres, chaînes, booléens).
          </p>
...
<span class="function">expect</span>(<span class="function">add</span>(<span class="number">2</span>, <span class="number">3</span>)).<span class="function">toBe</span>(<span class="number">5</span>);</code></pre>
          ...
          <p class="textExemple">
            <strong>Attention</strong> : <code>toBe()</code> ne fonctionne pas bien avec les objets ou tableaux. Pour ces types, utilisez <code>toEqual()</code>.
          </p>
        </div>
  ...
  <span class="property">"devDependencies"</span>: {
    <span class="property">"vitest"</span>: <span class="string">"^4.0.9"</span>
      ...
      <section class="lesson-section bg-light-purple border-purple">
        ...
        <p class="textExemple">
          Cette commande lance Vitest en mode watch, ce qui signifie qu'il surveillera vos fichiers et relancera les tests automatiquement à chaque modification.
        </p>
      ...
      <section class="lesson-section bg-light-purple border-purple">
        ...
        <ul class="textExemple">
          ...
          <li>Utilisez les matchers appropriés (<code>toBe</code>, <code>toEqual</code>, <code>toThrow</code>, etc.)</li>
    ...
    <span class="function">test</span>(<span class="string">'soustrait deux nombres positifs'</span>, () => {
      ...
      <section class="lesson-section bg-light-purple border-purple">
        ...
        <div class="exercise">
          ...
          <p class="textExemple">
            Créez une fonction <code>isEven</code> qui prend un nombre en paramètre et retourne <code>true</code> si le nombre est pair, <code>false</code> sinon. Ensuite, écrivez des tests pour cette fonction en couvrant différents cas:
          </p>
...
<span class="function">test</span>(<span class="string">'retourne false pour les nombres impairs'</span>, () => {
  ...
  <span class="function">expect</span>(<span class="function">isEven</span>(<span class="operator">-</span><span class="number">3</span>)).<span class="function">toBe</span>(<span class="keyword">false</span>);
      ...
      <section class="lesson-section bg-light-purple border-purple">
        ...
        <p class="textExemple">
          Félicitations! Vous avez maintenant les bases pour configurer et utiliser Vitest dans vos projets JavaScript. Vous savez:
        </p>
        ...
        <p class="textExemple">
          Continuez à pratiquer en ajoutant des tests à vos projets existants. Plus vous écrirez de tests, plus vous deviendrez efficace pour détecter et prévenir les bugs!
        </p>
      </section>
    </div>
  </div>
...
.property { color: #9cdcfe !important; } /* Propriétés d'objets */
